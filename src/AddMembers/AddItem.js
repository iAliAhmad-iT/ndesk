...
const AddItem = () => {
  ...
  const [serviceList, setServiceList] = useState([
    { design: "", customization: "", qty: "", cost: "" },
  ]);

  const addItem = () => {
    setServiceList([...serviceList,  { design: "", customization: "", qty: "", cost: "" }]);
  };
                ...
                <div className="col-12 d-flex product-details-border position-relative pe-0 fs-6">
                  <div className="row w-100 pe-lg-0 pe-1 py-3">
                    <div className="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                      <p className="card-text col-title mb-md-50 mb-0">Item</p>
                      <select
                        className="form-control item-details"
                        name="design"
                        value={input.design}
                    ...
                    <div className="col-lg-2 col-12 mt-lg-0 mt-2">
                      <p className="card-text col-title mb-md-50 mb-0">Price</p>
                  ...
                  <div className="d-flex flex-column align-items-center justify-content-between border-left invoice-product-actions py-2 px-2">
                    ...
                    <div className="dropdown">
                      ...
                      <div
                        className="dropdown-menu dropdown-menu-right item-options-menu p-2"
